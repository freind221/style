...
import 'package:style/modules/message/chat/chat_screen.dart';
import 'package:style/modules/place_order/myfatoorah_payment_screen.dart';
import 'package:style/modules/seller/become_seller_screen.dart';
import 'package:style/modules/setting/edit_address.dart';
import 'package:style/ui/chat_body.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RouteNames.allCategoryListScreen:
        return MaterialPageRoute(
            settings: settings, builder: (_) => AllCategoryListScreen());
